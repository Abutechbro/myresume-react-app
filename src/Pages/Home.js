...
class home extends Component {
    ...
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      ...
      <p>I'm a Web Developer, Web Designer &amp; Graphics Designer. </p>
      <div class="social-links">
        ...
        <a href="https://github.com/Abutechbro" class="google-plus"><i class="bx bxl-github"></i></a>
      </div>
    </div>
  </section>
  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+234 8144 83 5259</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Ogun State, Nigeria</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>idrisabubakry@gmail.com</span></li>
    ...
    <section id="skills" class="skills section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Skills</h2>
          <p>Here are the feeds am good at</p>
        </div>
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">WordPress <i class="val">99%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">Corel Draw<i class="val">90%</i></span>
              <div class="progress-bar-wrap">
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="resume-item pb-0">
              <h4>AbUtEcH bRo</h4>
              <p><em>Innovative and deadline-driven Web Developer with 3+ years of experience designing and developing user-centered Websites, polished deliverable.</em></p>
              <ul>
                <li>Ogun State, Nigeria</li>
                <li>(234) 8144-83-5259</li>
                <li>idrisabubakry@gmail.com</li>
              </ul>
            </div>
    ...
    {/* <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>Here are basically what i do</p>
        </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                 ...
                 it's a pleasure working with AbUtEcH bRo he delivered as promised.
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Me &amp; AbUtEcH bRo once work together as a team, trust me he blew my mind and the whole team mates with his dedications througout the project.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
              </div>
            </div>
            ...
            {/* <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  He is so passsionate about is skills and deliver his best always.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
              </div>
            </div> */}
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Nigeria Ogun State &amp; Lagos State.</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>idrisabubakry@gmail</p>
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call:</h4>
                <p>+234 8144 83 5259</p>
              </div>
